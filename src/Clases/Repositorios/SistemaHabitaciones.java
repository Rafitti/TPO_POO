...
import Clases.Interfaces.IHabitacionRepository;

import java.util.*;

public class SistemaHabitaciones implements IHabitacionRepository {
  ...
  public List<Habitacion> getAll() throws DatabaseException {
  ...
  public List<Habitacion> getBy(Map<String,Object> where) throws DatabaseException {
  ...
  public Habitacion create(int numero, TipoHabitacion tipo, int idEmpleadoACargo) throws DatabaseException {
